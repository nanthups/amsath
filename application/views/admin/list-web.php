				...
				<div class="main-content-inner">
					<div class="breadcrumbs ace-save-state" id="breadcrumbs">
						<ul class="breadcrumb">
							...
							<li class="active">List Web Links</li>
						</ul><!-- /.breadcrumb -->
							...
							<h1>
                              ...
                              <div class="col-sm-12" align="right">  
                                ...
                                <p>
								 ...
								 <a class="btn btn-sm btn-yellow" href="<?php echo site_url('admin/list-web');?>"><i class="ace-icon fa fa-refresh"></i>Reset</a>    
							      </p>
                                ...
                                <div class="space-6"></div>
                                         ...
                                         <div class="alert alert-danger">
                                           ...
                                           if($btnaction=='search')
                                            {
											    $form_action = 'admin/list-web/search';
											 }
											 ?>
											
												<div class="row hide_div"  style="display:<?=$srdiv?>"  id="srdiv">					
										<form role="form" action="<?php echo site_url('admin/list-web/searchs');?>" method="post" enctype="multipart/form-data" >
                  ...
                  <input type="text" class="form-control" value="<?php echo $mobile;?>" placeholder="" name="mobile" id="un" />
														</div>
										...
										<a class="btn btn-sm" type="reset"  href="<?php echo site_url('admin/list-web');?>"><i class="ace-icon fa fa-refresh"></i>Reset	</a>
                             ...
                             <div class="table-responsive">
                                       ...
                                       $arr_fields1 = $this->Reg_model->get_row('users','fname',array('id'=>$row->user_id));	 ?>										                                                 
												<tr>
                                                    <td><?php echo $arr_fields1->fname; ?></td>
                                                 	<td><?php echo $row->mobile; ?></td>
                                                 	<td><?php echo $row->whatsapp; ?></td>
												    <td><?php echo $row->skype; ?></td>
													 <td><?php echo $row->behance; ?></td>
													  <td><?php echo $row->address; ?></td>

													<td>
														                        
                                                          
                                                          <a href="<?php echo site_url('admin/list-web/delete/'.$row->uc_id);?>" role="button" onClick="return confirm('Do you want to delete this Web Links?')" class="btn btn-xs btn-danger" ><i class="ace-icon fa fa-trash-o bigger-120"></i></a>
