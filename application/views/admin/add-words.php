...
<?php
                                ...
                                <?php
									...
									<?php
                                           ...
                                           if($btnaction=='edit')
                                            {
											    $form_action = 'admin/add-words/edit';
											 }
											 else if($btnaction=='add')
											 {
											    $form_action = 'admin/add-words/add';
											 }
 ...
 <form role="form" action="<?=site_url($form_action)?>" method="post" enctype="multipart/form-data" id="form" >
                  ...
                  <input type="text" class="form-control" value="<?php echo $words;?>" name="words" id="words" required />
														</div>
										...
										<div class="col-md-offset-3 col-md-9">
                                         ...
                                         <?php
                                            ...
                                            ?>
		<a href="<?php echo site_url('admin/list-words');?>"><button class="btn" type="button" name="Cancel" ><i class="ace-icon fa fa-undo bigger-110"></i>Cancel</button></a>
