...
<?php
                                ...
                                <?php
									...
									<?php
                                           ...
                                           if($btnaction=='edit')
                                            {
											    $form_action = 'admin/add-category1/edit';
											 }
											 else if($btnaction=='add')
											 {
											    $form_action = 'admin/add-category1/add';
											 }
									...
									<div class="col-xs-12 col-sm-12">
										...
										<div class="col-md-offset-3 col-md-9">
                                         ...
                                         <?php
                                            ...
                                            ?>
		<a href="<?php echo site_url('admin/list-category1');?>"><button class="btn" type="button" name="Cancel" ><i class="ace-icon fa fa-undo bigger-110"></i>Cancel</button></a>
