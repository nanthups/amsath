...
if($this->uri->uri_string() == 'admin/list-category2') {
 ...
 // $menu11 = "active highlight";
  ...
  if($this->session->userdata('user_type')=="admin" || $this->session->userdata('user_type')=="executive") 
  {
	...
	if($this->uri->uri_string(1) == 'admin/list-vmsg')
  $menu21 = "active highlight";
  if($this->uri->uri_string(2) == 'admin/add-vmsg/add')
  $menu21 = "active highlight";
    //if($this->uri->segment(3) == 'e')
 // $menu11 = "active highlight";
  if($this->uri->segment(3) == 'search')
  $menu21 = "active highlight";
   ...
   if($this->uri->uri_string(1) == 'admin/list-words')
  $menu22 = "active highlight";
  if($this->uri->uri_string(2) == 'admin/add-words/add')
  $menu22 = "active highlight";
    if($this->uri->segment(3) == 'editwords')
  $menu22 = "active highlight";
  if($this->uri->segment(3) == 'search')
  $menu22 = "active highlight";
  
  
  if($this->uri->uri_string(1) == 'admin/list-chat')
  $menu23 = "active highlight";
  if($this->uri->uri_string(2) == 'admin/add-chat/add')
  $menu23 = "active highlight";
    //if($this->uri->segment(3) == 'e')
 // $menu11 = "active highlight";
  if($this->uri->segment(3) == 'search')
  ...
  if($this->uri->uri_string(1) == 'admin/list-photos')
  $menu24 = "active highlight";
  if($this->uri->uri_string(2) == 'admin/add-photos/add')
  $menu24 = "active highlight";
    //if($this->uri->segment(3) == 'e')
 // $menu11 = "active highlight";
  if($this->uri->segment(3) == 'search')
...
<div id="sidebar" class="sidebar  responsive  ace-save-state">
				...
				<ul class="nav nav-list">
					...
					<?php
					 ...
					 if($this->session->userdata('user_type')=="admin" || $this->session->userdata('user_type')=="monitor") 
  						{
					...
					<a href="<?=site_url('admin/list-website')?>">
							...
							<li class="<?=$menu22?>">
					<a href="<?=site_url('admin/list-words')?>">
									<i class="menu-icon fa fa-pencil"></i>
									<span class="menu-text">Manage Listed Words</span>
								</a>
						...
						<?php
						 if($this->session->userdata('user_type')=="admin" || $this->session->userdata('user_type')=="controller") 
  						{

					?>	
					
					<li class="<?=$menu24?>">
					<a href="<?=site_url('admin/list-photos')?>">
									<i class="menu-icon fa fa-list"></i>
									<span class="menu-text"> Manage Seller Photos</span>
								</a>
					...
					<a href="<?=site_url('admin/list-reg')?>">
							 ...
							 <li class="<?=$menu23?>">
					<a href="<?=site_url('admin/list-chat')?>">
									<i class="menu-icon fa fa-whatsapp"></i>
									<span class="menu-text">Manage Chat</span>
								</a>
							...
							<!-- <li class="<?=$menu21?>">
					<a href="<?=site_url('admin/list-vmsg')?>">
									<i class="menu-icon fa fa-commenting-o"></i>
									<span class="menu-text">Manage User Msg</span>
								</a>
